...
public class Test_create_comp_fromCompList extends Base2{
	...
	companylist com=new companylist(driver);
	wait.until(ExpectedConditions.visibilityOf(com.createcomp()));
	com.createcomp().click();
